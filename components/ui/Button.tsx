import React, { forwardRef, ButtonHTMLAttributes, PropsWithChildren } from "react";
...
const loadingSVG = (
  <svg
    aria-hidden="true"
    className="w-5 h-5 mr-2 text-gray-200 animate-spin dark:text-blue-200 fill-white"
    viewBox="0 0 100 101"
    fill="none"
